########################################################################
# Alternative implementation of OSGB36 (BNG) to WGS84 coordinate       #
# conversion by Stephan Hugel (urschrei@gmail.com), adapted from:      #
# https://github.com/urschrei/lonlat_bng/blob/master/src/bng_lonlat.py #
# licensed under the MIT License.                                      #
# Currently used in place of the Rust implementation due to issue on   #
# i5-3570S: https://github.com/rust-lang/rust/issues/40125             #
########################################################################
