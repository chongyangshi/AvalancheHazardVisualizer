...
\textbf{Development requirements}: The project should be developed in a version control system such as Git, and a detailed deployment documentation should be provided to allow any experienced system administrator to redeploy the application.
...
\section{Structure of the system} \label{sec:app-system}
...
\subsection{Static risk data} \label{subsec:static-risk-processing}

\subsection{Past avalanches} \label{subsec:past-avalanche-data}

\section{The API server} \label{sec:api-server}
