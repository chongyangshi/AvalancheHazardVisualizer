...
This chapter provides details on the implementation of the software system of the application. Starting with an overview on the architecture design in Section \ref{sec:app-system}, different aspects of the implementation will be covered: retrieval processing of various types of data (\ref{sec:data-processing}), the API servers serving as an intermediate between data and the user interface (\ref{sec:api-server}), and the user interface itself (\ref{sec:user-interface}).
