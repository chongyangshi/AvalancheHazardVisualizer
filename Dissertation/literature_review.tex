...
\begin{tabular}{|>{\centering\arraybackslash}p{2.6cm}|>{\centering\arraybackslash}p{2.6cm}|>{\centering\arraybackslash}p{2.9cm}|>{\centering\arraybackslash}p{2.6cm}|>{\centering\arraybackslash}p{2.6cm}| } 
 ...
 \hline
\end{tabular}
\caption{\label{fig:new-avalanche-scale} The new colour scheme implemented in \textbf{Stage 3}.}
\end{figure}
...
The resulting risk colour scheme, used by the final product of \textbf{Stage 3}, can be seen in Figure \ref{fig:final-colour-scheme}. The effects of static risk controlling saturation can also be observed in Figure \ref{fig:stage1bennevis} (right). 

\begin{figure}[h]
		\centering
		\includegraphics[height=5cm]{final-colour-scheme.png}
		\caption{\label{fig:final-colour-scheme} The new risk colour scheme implemented in the final product. Each row represents a dynamic risk level.}
\end{figure}
